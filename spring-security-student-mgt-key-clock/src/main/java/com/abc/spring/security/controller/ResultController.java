...
public class ResultController {
    ...
    @GetMapping("/{userId}")
    @PreAuthorize("hasAnyRole('ADMIN', 'MODERATOR') or (hasRole('STUDENT') and #userId == authentication.name)")
    public ResponseEntity<String> getResultByUserId(@PathVariable String userId, Authentication authentication) {
